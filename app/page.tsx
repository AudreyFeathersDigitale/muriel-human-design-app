...
function Orb({ size = "h-36 w-36" }) {
  return (
    <motion.div
      ...
      className={`${size} relative rounded-full bg-[radial-gradient(circle_at_35%_30%,#ffffff_0%,#DDF7F8_22%,#2CBCC3_52%,#ffffff00_74%)] shadow-[0_0_70px_rgba(44,188,195,.35)]`}
    >
...
function Shell({ children }: { children: React.ReactNode }) {
  return (
    <main className="min-h-screen overflow-hidden bg-[#F8F4ED] text-[#0E5A66]" style={{ fontFamily: "Poppins, sans-serif" }}>
      <div className="pointer-events-none fixed -left-32 -top-32 h-96 w-96 rounded-full bg-[#2CBCC3]/20 blur-3xl" />
      <div className="pointer-events-none fixed -right-20 top-1/3 h-80 w-80 rounded-full bg-[#C8A96A]/10 blur-3xl" />
...
function PhoneFrame({ children }: { children: React.ReactNode }) {
  return (
    <div className="mx-auto min-h-[860px] w-full max-w-[430px] overflow-hidden rounded-[2rem] border border-[#D9E5E6] bg-white/95 shadow-[0_24px_80px_rgba(14,90,102,.12)] backdrop-blur-xl">
      {children}
    </div>
  );
}
  ...
  return (
    <PhoneFrame>
      <div className="flex min-h-[860px] flex-col p-7">
        ...
        <p className="mt-8 text-lg leading-7 text-[#0E5A66]">
          En 3 minutes, découvre le mécanisme qui influence aujourd&apos;hui ton énergie
          et fais le premier pas vers un fonctionnement plus naturel.
        </p>
        ...
        <div className="mt-10 space-y-7">
          {[
            ...
            <div key={title} className="flex gap-5">
              <div className="grid h-14 w-14 shrink-0 place-items-center rounded-full bg-[#2CBCC3]/70 shadow-lg shadow-[#2CBCC3]/30">
                <Icon className="h-7 w-7 text-[#0E5A66]" />
              </div>
              <div>
                <div className="text-lg font-semibold">{title}</div>
                <p className="mt-1 leading-6 text-[#0E5A66]">{text}</p>
              </div>
            </div>
          ))}
        </div>
        ...
        >
          Je fais le quiz gratuitement <ArrowRight className="h-5 w-5" />
        </button>

        <div className="mt-5 flex justify-center gap-2 text-sm text-[#0E5A66]">
        ...
        <div className="flex min-h-[860px] flex-col p-6">
          ...
          <div className="mt-14 flex gap-4">
            <div className="grid h-12 w-12 shrink-0 place-items-center rounded-full bg-white shadow-sm">
              <Sparkles className="text-[#C8A96A]" />
            </div>
            ...
            <motion.div
              ...
              className="rounded-[1.7rem] border border-[#D9E5E6] bg-white/75 p-6 text-[17px] leading-8 shadow-sm"
            >
          ...
          <div className="mt-8 flex justify-end">
            <button
              ...
              className="rounded-[1.4rem] bg-[#DDF7F8] px-7 py-4 text-[16px] font-medium text-[#0E5A66] shadow-sm transition hover:scale-[1.02] hover:bg-[#C9F1F3]"
            >
              Oui, je suis prête
            </button>
          </div>
          ...
          <div className="mt-5 flex justify-center gap-2 text-xs text-[#6B858A]">
      ...
      <div className="flex min-h-[860px] flex-col p-6">
        <header className="flex items-center justify-between">
          ...
          <div className="grid h-11 w-11 place-items-center rounded-full bg-white shadow-sm">
            <CurrentIcon className="h-5 w-5 text-[#2CBCC3]" />
          </div>
        </header>

        <div className="mt-8 h-2 rounded-full bg-[#DDEBEC]">
          <motion.div
            className="h-full rounded-full bg-[#2CBCC3]"
        ...
        <AnimatePresence mode="wait">
          <motion.div
            ...
            className="mt-8 rounded-[2rem] border border-[#D9E5E6] bg-white/65 p-5 shadow-sm"
          >
            <div className="text-sm font-bold uppercase tracking-wide text-[#C8A96A]">
              {current.theme}
            </div>
            ...
            <p className="mt-4 text-[15px] leading-7 text-[#0E5A66]">
            ...
            <div className="mt-6 space-y-3.5">
              {current.answers.map((answer) => (
                <button
                  ...
                  className="flex w-full items-center gap-5 rounded-2xl border border-[#D9E5E6] bg-white/80 p-5 text-left text-[16px] leading-7 shadow-sm transition hover:-translate-y-0.5 hover:border-[#2CBCC3] hover:bg-white hover:shadow-md"
                >
  ...
  return (
    <PhoneFrame>
      <div className="flex min-h-[860px] flex-col items-center justify-center p-7 text-center">
        ...
        <p className="mt-5 text-lg leading-8 text-[#0E5A66]">
        ...
        <button
          onClick={onNext}
          className="mt-12 flex h-14 w-full items-center justify-center gap-3 rounded-full bg-gradient-to-r from-[#2CBCC3] to-[#24AAB1] px-6 text-lg font-semibold text-white shadow-xl shadow-[#2CBCC3]/25 transition hover:scale-[1.01]"
        >
          Continuer
    ...
    <PhoneFrame>
      <form onSubmit={handleSubmit} className="flex min-h-[860px] flex-col p-7">
        <div className="mt-10 text-center">
          <div className="mx-auto grid h-20 w-20 place-items-center rounded-full bg-[#F8F1E5] text-[#C8A96A]">
          ...
          <p className="mt-5 text-base leading-7 text-[#0E5A66]">
            Découvre ton archétype dominant, ton défi principal et les clés pour retrouver plus de clarté, d'élan et d'alignement.
          </p>
        </div>

        <div className="mt-8 rounded-[2rem] border border-[#D9E5E6] bg-white/60 p-5 shadow-sm">
          <div className="space-y-3 text-sm leading-6 text-[#0E5A66]">
        ...
        <div className="mt-8 space-y-4">
          <input
            ...
            className="h-14 w-full rounded-2xl border border-[#D9E5E6] bg-white px-5 text-[#0E5A66] outline-none transition placeholder:text-[#8AA3A7] focus:border-[#2CBCC3]"
          />
        ...
        <button
          type="submit"
          className="mt-8 flex h-14 w-full items-center justify-center gap-3 rounded-full bg-gradient-to-r from-[#2CBCC3] to-[#24AAB1] px-6 text-base font-semibold text-white shadow-xl shadow-[#2CBCC3]/25 transition hover:scale-[1.01]"
        >
  ...
  return (
    <PhoneFrame>
      <div className="min-h-[860px] p-6">
        ...
        <div className="mt-8 rounded-[2rem] border border-[#D9E5E6] bg-white/70 p-6 shadow-sm">
          <div className="flex items-center gap-6">
            <div className="grid h-28 w-28 shrink-0 place-items-center rounded-full border-4 border-[#C8A96A] text-5xl shadow-[0_0_50px_rgba(213,160,33,.25)]">
              {result.emoji}
            </div>
        ...
        <div className="mt-4 grid grid-cols-1 gap-4">
          {cards.map(([Icon, title, text, bg, color, iconBg, iconColor]: any) => (
            <div
              key={title}
              className={`${bg} rounded-3xl border border-[#D9E5E6]/60 p-5 text-center shadow-sm`}
            >
        ...
        <div className="mt-8 rounded-[2rem] bg-gradient-to-br from-[#C8A96A] to-[#B6914D] p-7 text-center text-white shadow-xl shadow-[#C8A96A]/20">
          ...
          <a
            ...
            className="mt-6 flex w-full items-center justify-center gap-3 rounded-full bg-white px-6 py-4 font-semibold text-[#0E5A66] transition hover:scale-[1.02] hover:bg-[#F8F4ED]"
          >
